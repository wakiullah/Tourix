   ...
   return (
      <>
         <div className="d-flex justify-content-between align-items-center mb-10">
            ...
            <Link className="tg-filter-clear" href="#">Clear All</Link>
         </div>
            ...
            <div className="tg-booking-form-parent-inner tg-hero-quantity p-relative mb-15">
               ...
               <div className="tg-booking-form-location-list tg-quantity tg-booking-quantity-active">
                  <ul>
                     <li>
                        ...
                        <div className="tg-booking-quantity-item">
                           ...
                           <input className="tg-quantity-input" type="text" defaultValue="1" />
                     ...
                     <li>
                        ...
                        <div className="tg-booking-quantity-item">
                           ...
                           <input className="tg-quantity-input" type="text" defaultValue="0" />
                           <span className="decrement">
                              <svg width="14" height="2" viewBox="0 0 14 2" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <path d="M1 1H13" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                              </svg>
                  ...
                  <div className="tg-booking-form-search-btn mt-15 ">
                     <button className="bk-search-button w-100" type="submit">Ok</button>
                  </div>
               </div>
            </div>
