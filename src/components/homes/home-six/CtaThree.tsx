...
const CtaThree = () => {
   return (
      <div className="tg-banner-area tg-banner-4-spacing" style={{ backgroundImage: `url(/assets/img/banner/banner-4/banner-4.png)` }}>
         <div className="container">
            <div className="col-lg-12">
               <div className="tg-banner-2-content tg-banner-4-content text-center">
         ...
         <div className="tg-banner-bottom pb-150">
